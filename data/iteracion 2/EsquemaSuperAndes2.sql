...
ID NUMBER,
carrito NUMBER,
producto VARCHAR(255 BYTE) NOT NULL,
CONSTRAINT A_CONTIENE_PK PRIMARY KEY (ID)
);
ALTER TABLE A_CONTIENE ADD CONSTRAINT fk_contienePro FOREIGN KEY (producto) REFERENCES A_PRODUCTO(CODIGODEBARRAS);
ALTER TABLE A_CONTIENE ADD CONSTRAINT fk_contieneCarro FOREIGN KEY (carrito) REFERENCES A_CARRITO(ID);
...
ALTER TABLE A_CARRITO ADD CONSTRAINT fk_clienteCa FOREIGN KEY (clinte) REFERENCES A_CLIENTE(CODIGO);
